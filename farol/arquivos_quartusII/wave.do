...
add wave -noupdate -color Cyan -radix binary /atividade_farol/farol
add wave -noupdate -color Red -radix binary /atividade_farol/porta
add wave -noupdate -color Yellow -radix binary /atividade_farol/chave
add wave -noupdate -radix binary /atividade_farol/saida
